...
<head>
    ...
    <title>Hair Care Services Price For Men</title>
...
<div class="heading">
        <h1>Hair Care Services Price For Men</h1>
...
<div class="table-responsive">
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>02</td>
        <td><img src="images/pic16.png" alt=""></td>
      ...
      <tr>
        <td>03</td>
        <td><img src="images/pic17.png" alt=""></td>
        <td>Hair colour</td>
        <td>Rs.300</td>
        <td>
          <span class="action_btn">
